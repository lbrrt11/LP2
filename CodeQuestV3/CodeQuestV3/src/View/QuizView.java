...
public class QuizView {
    ...
    // Exibe a pergunta e opções, e pede a resposta do usuário diretamente
    public String exibirQuestao(Questao questao) {
        StringBuilder sb = new StringBuilder();
        sb.append(exibirPergunta(questao)).append("\n");
        sb.append(exibirOpcoes(questao));

        // Usando showInputDialog para permitir que o usuário digite a resposta
    ...
    // Exibe a pergunta
    private String exibirPergunta(Questao questao) {
        return questao.getPergunta();
    }

    // Exibe as opções
    private String exibirOpcoes(Questao questao) {
        StringBuilder sb = new StringBuilder();
